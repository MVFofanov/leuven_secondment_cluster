...
#SBATCH --job-name=atlas_run_genomes
...
atlas run genomes --profile cluster -w /home/zo49sog/crassvirales/leuven_secondment/atlas_results \
	-c /home/zo49sog/crassvirales/leuven_secondment/atlas_results/config.yaml 
